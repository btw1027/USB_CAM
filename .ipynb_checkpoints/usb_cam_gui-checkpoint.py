...
def __stereo_gui(): # pylint: disable=too-many-locals,too-many-statements
    ...
    # Primary gain
    gain_primary_pos = [0, start_stream_button_pos[1]-options_height-padding, 0.5, options_height]
    ...
    # Exposure
    exposure_pos = [0, gain_primary_pos[1]-options_height-padding, 0.5, options_height]
    ...
    # drawtool button
    drawtool_button_pos = [.55, gain_primary_pos[1]-options_height-padding, 0.1, options_height]
    ...
    distancetext_pos = [.75, gain_primary_pos[1]-options_height-padding, 0.25, options_height]
    ...
    # FPS
    fps_pos = [0, exposure_pos[1]-options_height-padding, 0.5, options_height]
    ...
    save_primary_button_pos = [padding,
